...
void loop() {
  ...
  if (digitalRead(userButton3)==0){     // Check if userButton1 Pressed or NOT, LOW when Pressed else HIGH
    Serial.println("Button 3 Pressed!");
    beep(1245,500);
    delay(50);
  }

  if (digitalRead(userButton4)==0){     // Check if userButton2 Pressed or NOT, LOW when Pressed else HIGH
