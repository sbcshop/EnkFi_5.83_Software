/* Onboard E-paper Display Demo for Graphics print */
...
void setup()
{
  ...
  Graphics_DrawRectangle(200, 200, 400, 350, BLACK, DOT_PIXEL_1X1, DRAW_FILL_EMPTY);
  ...
  Graphics_SelectImage(redImg);
  //Graphics_Clear(WHITE);
  Graphics_DrawPoint(200, 200, RED, DOT_PIXEL_3X3, DOT_STYLE_DFT);
  Graphics_DrawPoint(400, 350, RED, DOT_PIXEL_3X3, DOT_STYLE_DFT);
